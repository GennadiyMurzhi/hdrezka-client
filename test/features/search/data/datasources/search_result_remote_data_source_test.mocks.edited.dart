...
// in hdrezka_client/test/features/search/data/datasources/search_result_remote_data_source_test.dart.
...
class HttpClientMock extends _i1.Mock implements _i4.Client {
  final Object valueForMissingStub;

  HttpClientMock({required this.valueForMissingStub});
  ...
  _i5.Future<_i2.Response> post(Uri? url,
      ...
      (super.noSuchMethod(
              ...
              returnValueForMissingStub: valueForMissingStub,
              returnValue: Future<_i2.Response>.value(_FakeResponse_0()))
          as _i5.Future<_i2.Response>);
  @override
